...
from asterdex.api.v1.client import V1Client
...
class TestV1Client:
    ...
    async def test_ping(self):
        client = V1Client("key", "secret", Network.TESTNET)
    ...
    async def test_get_order_book(self):
        ...
        result = await client.get_order_book("BTCUSDT", limit=10)
    ...
    async def test_get_klines_with_time_range(self):
        ...
        result = await client.get_klines(
            "BTCUSDT", "1h", start_time=1234567890000, end_time=1234567900000
        )
        assert isinstance(result, list)
    ...
    async def test_get_ticker_24h(self):
        client = V1Client("key", "secret", Network.TESTNET)
        client.get = AsyncMock(return_value={"symbol": "BTCUSDT", "price": "50000"})
    ...
    async def test_get_mark_price(self):
        client = V1Client("key", "secret", Network.TESTNET)
        client.get = AsyncMock(return_value={"symbol": "BTCUSDT", "markPrice": "50000"})
    ...
    async def test_get_all_orders(self):
        ...
        result = await client.get_all_orders("BTCUSDT")
        assert isinstance(result, list)

    @pytest.mark.asyncio
    async def test_get_balance(self):
        client = V1Client("key", "secret", Network.TESTNET)
        client.get = AsyncMock(return_value=[{"asset": "BTC", "balance": "1.0"}])
...
class TestClientFactory:
    def test_create_v1_client(self):
        client = Client.v1(api_key="key", secret_key="secret", enable_v1=True)
        assert client._client.api_version == "v1"
    ...
    def test_create_with_network(self):
        client = Client.v1(
            api_key="key", secret_key="secret", network=Network.MAINNET, enable_v1=True
        )
        assert client._client.base_url == Network.MAINNET.rest_url

    def test_create_with_testnet_default(self):
        client = Client.v1(api_key="key", secret_key="secret", enable_v1=True)
