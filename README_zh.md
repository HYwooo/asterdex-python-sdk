...
本软件是一个 **个人项目**，与 Aster DEX 无任何官方关联，未获得其认可或背书。本软件仅用于教育目的和个人实验。

**风险警告：** 加密货币交易涉及重大风险，可能导致您的资金完全损失。数字资产的高波动性可能导致快速且巨大的财务损失。

**责任免除：** 本软件的作者不对因使用本软件而产生的任何直接、间接、偶然、必然或惩罚性损害负责，包括但不限于交易损失、API 错误、网络问题或数据丢失。

**使用指南：**
- 仅使用您能够完全承受损失的资金
- 在任何实际使用前，在测试环境中彻底测试所有功能
- 了解加密货币交易和区块链技术的基础知识
- 遵守所有适用的当地、国家和国际法律法规

使用本软件即表示您承认并接受这些风险，并同意自行承担使用风险。
